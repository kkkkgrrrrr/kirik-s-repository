    ...
    public class Game
    {
        ...
        public class Engine
        {
            ...
            public void RunGame()
            {
                ...
                Drawing2nd(DialogWindow.DialogWindow_Visual.dialogCompanionPortrait, 0, 0, ConsoleColor.DarkMagenta);
            ...
            public class Info
            {
                ...
                public abstract class Properties
                {
                    ...
                    static Mercant mercantinf = new Mercant(false, true);
                    ...
                    public static Properties[,] Buildmatrix(string[,][,] map)
                    {
                        ...
                        for (int i = 0; i < map.GetLength(0); i++)
                        {
                            for (int j = 0; j < map.GetLength(1); j++)
                            {
                                ...
                                if (map[i, j] == Textures.NPC.Mercant.movingModelOfMerchantR1)
                                {
                                    matrix[i, j] = mercantinf;
                                    matrix[i - 1, j - 1] = mercantinf;
                                    matrix[i - 1, j] = mercantinf;
                                    matrix[i, j - 1] = mercantinf;
                                }
                    ...
                    {
                        Info info = new Info();
                        if (matrix[(int)(nextY / Textures.Player.movingModelOfPlayerL1.GetLength(0)), (int)(nextX / Textures.Player.movingModelOfPlayerL1.GetLength(1))] == mercantinf)
                        {
                        ...
                        if (matrix[(int)(nextY / Textures.Player.movingModelOfPlayerL1.GetLength(0)), (int)(nextX / Textures.Player.movingModelOfPlayerL1.GetLength(1))] == coin1inf)
                        {
                            ...
                            int xx = GetIndexesOfArray2D(matrix, coin1inf)[0];
                            int yy = GetIndexesOfArray2D(matrix, coin1inf)[1];
                            matrix[yy, xx] = clearinf;
                            matrix[yy - 1, xx] = clearinf;
                            matrix[yy, xx - 1] = clearinf;
                            matrix[yy - 1, xx - 1] = clearinf;
                    ...
                    public class Mercant : Properties
                    {
                        public Mercant(bool IsPassable, bool IsResponse) : base(IsPassable, IsResponse)
                        {
                        }
                    }
            ...
            {
                public class DialogWindow_Visual
                {
                    public static string[,] dialogCompanionName =
                    {
                    {"█"," "," "," ","█"," ","█","█","█","█"," ","█","█","█"," "," "," ","█","█","█"," "," ","█","█"," "," ","█"," "," "," ","█"," ","█","█","█","█","█", },
                    {"█","█"," ","█","█"," ","█"," "," "," "," ","█"," "," ","█"," ","█"," "," "," "," ","█"," "," ","█"," ","█","█"," "," ","█"," "," "," ","█"," "," ", },
                    {"█"," ","█"," ","█"," ","█","█","█","█"," ","█","█","█"," "," ","█"," "," "," "," ","█","█","█","█"," ","█"," ","█"," ","█"," "," "," ","█"," "," ", },
                    ...
                    public static string[,] dialogCompanionPortrait =
                    {
                    {" "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ", },
                    {" "," "," "," "," "," "," "," "," "," ","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█"," "," "," "," "," "," "," "," "," "," "," "," ", },
                    {" "," "," "," "," "," ","█","█","█","█","█"," ","█"," ","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█","█"," ","█","█","█","█","█"," "," "," "," "," "," "," "," ", },
            ...
            public class Render
            {
                ...
                {
                    { Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1,Textures.Walls.wall1, },
                    { Textures.Walls.wall1,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Walls.wall1},
                    { Textures.Walls.wall1,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Walls.wall1},
                    { Textures.Walls.wall1,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Walls.wall1},
                    { Textures.Walls.wall1,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.NPC.Mercant.movingModelOfMerchantR1,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Pustota.pustota,Textures.Walls.wall1},
                ...
                public static void Draw(string[,][,] bArray)
                {
                    ...
                    for (int y = 0; y < bArray.GetLength(0); y++)
                    {
                        for (int x = 0; x < bArray.GetLength(1); x++)
                        {
                            ...
                            else if (bArray[y, x] == Textures.NPC.Mercant.movingModelOfMerchantR1)
                            {

                                Drawing2nd(bArray[y, x], render.X(x), render.Y(y), ConsoleColor.DarkMagenta);
                            }
                            else
                            {
            ...
            public static void Moving()
            {
                ...
                while (true)
                {
                    ...
                    {
                        case ConsoleKey.W:
                            playerNextY -= (int)(playerInfo.speed / 6);
                            break;
                        case ConsoleKey.S:
                            playerNextY += (int)(playerInfo.speed / 6);
                            break;
                        case ConsoleKey.D:
                            ...
                            playerNextX += (int)(playerInfo.speed / 3);
                            break;
                        case ConsoleKey.A:
